...
```{r, echo=FALSE}
# read in the data
performanceData <- readr::read_delim(file = "~/Documents/analytics/NY_Philarchive_performanceHistory/Programs/NY_Philharmonic_df.csv", delim = "|")
# drop the NA column
...
ggplot(popWorks[1:nWorks,], aes(x = reorder(composerName, -nPerf), 
                     ...
                     label = workTitle)) +
  geom_point(aes(colour = rank)) +
  scale_colour_manual(values = wes_palette("Darjeeling", nWorks, "continuous")) +
